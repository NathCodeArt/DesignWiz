  ...
  <section id="general_section">
    ...
    <div class="central">
      <h1>Registro de ingresos y gastos</h1>
        ...
        <form class="form-group row" action="../back/back_app/modulo3/ingresos_gastos.php" method="POST">
                    ...
                    <div class="input-group-prepend">
                        <div class="input-group-text">
                          <svg class="icons_form" fill="none" height="24" stroke-width="1.5" viewBox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg">
                            <rect height="5" rx="0.6" stroke="currentColor" stroke-width="1.5" transform="matrix(1 0 0 -1 3 22)" width="7"/>
                            <rect height="5" rx="0.6" stroke="currentColor" stroke-width="1.5" transform="matrix(1 0 0 -1 8.5 7)" width="7"/>
                            <rect height="5" rx="0.6" stroke="currentColor" stroke-width="1.5" transform="matrix(1 0 0 -1 14 22)" width="7"/>
